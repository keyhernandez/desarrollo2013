...
class ProrestController {
    ...
    * Toma una URL y retorna un mapa con sus datos
    */
    ...
    */
    def productos_rest = {
        //cambiar por la URL que se leera y que retorna el JSON con la estructura que aparece arriba
        def url_t = 'http://localhost:7070/GrailsApplication2/rest/json_test/'
